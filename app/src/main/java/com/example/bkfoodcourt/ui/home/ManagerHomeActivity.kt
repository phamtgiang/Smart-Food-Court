...
import com.example.bkfoodcourt.ui.manager.RechargeBalanceAccountActivity
import com.example.bkfoodcourt.ui.manager.SeeFoodCourtReportActivity
...
import kotlinx.android.synthetic.main.activity_manager_home.viewPager
...
class ManagerHomeActivity : AppCompatActivity() {
    ...
    private val slideAdapter = CustomPagerAdater(
        listOf(
            ...
            PagerItem("View Report", "report.json", "View report of whole food court"),
            PagerItem("Recharge balance", "recharge.json", "Recharge customer's account balance"),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonSelect.setOnClickListener{
            ...
            if (idx == 0){
                ...
                startActivity(Intent(this, RechargeBalanceAccountActivity::class.java))
            }
            else{
                showAlertDialog()
            }
