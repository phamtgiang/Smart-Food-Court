...
import com.example.bkfoodcourt.ui.cook.SeeOrderListActivity
import com.facebook.login.LoginManager
import com.google.firebase.auth.FirebaseAuth
import kotlinx.android.synthetic.main.activity_manager_home.*

class CookHomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonSelect.setOnClickListener{
            ...
            if (idx == 0){
                ...
                startActivity(Intent(this, SeeOrderListActivity::class.java))
            }
            else if (idx == 2){
